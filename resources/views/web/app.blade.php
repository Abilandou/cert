...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Certification - @yield('title')</title>
        ...
        <style>
            body {
                ...
                background-color: rgba(222, 222, 247, 0.692);
                background-image: url('{{ asset('public/front_assets/img/certbg.png') }}');
            ...
            .bg-warning {
                background-color: #f8be5163 !important;
            }
